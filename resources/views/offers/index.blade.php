    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="form-inline my-2 my-lg-0">
                <input class="form-control mr-sm-2" type="search" placeholder="{{__('messages.Offer Search')}}" aria-label="Search">
                <button class="btn btn-outline-success my-2 my-sm-0" type="submit">{{__('messages.Offer Search')}}</button>
            </form>
        </div>
    </div>
</nav>

<table class="table" style="width:50%; :center;">
    <thead>
    <tr>
        <th scope="col">#</th>
